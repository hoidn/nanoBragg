echo "WARNING: /home/ollie/Documents/tmp/nanoBragg/simforge/etc/profile.d/mamba.sh (the file emitting this warning) is deprecated."
...
if [ -z "" ]; then
    ...
    echo "WARNING: "
    echo "WARNING: For now, we are setting 'MAMBA_ROOT_PREFIX' to '/home/ollie/Documents/tmp/nanoBragg/simforge'."
    echo "WARNING: "
    ...
    echo "WARNING: "
    echo "WARNING: This message originates from /home/ollie/Documents/tmp/nanoBragg/simforge/etc/profile.d/mamba.sh"
    export MAMBA_ROOT_PREFIX="/home/ollie/Documents/tmp/nanoBragg/simforge"
fi

__mamba_setup="$("/home/ollie/Documents/tmp/nanoBragg/simforge/bin/mamba" shell hook --shell posix 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__mamba_setup"
else
    alias mamba="/home/ollie/Documents/tmp/nanoBragg/simforge/bin/mamba"  # Fallback on help from mamba activate
fi
unset __mamba_setup
