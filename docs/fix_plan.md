...
- Risks/Assumptions: 1024² CPU performance acceptable given GPU alternative; Phase 4 revisit only if future profiling identifies specific bottlenecks. P3.0c weighted-source validation now corrected and valid.
- Exit Criteria (quote thresholds from spec):
