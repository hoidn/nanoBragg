...
- Next Actions (2025-10-08 Phase M1 complete):
  ...
  - **Phase M5 (Option 1 spec compliance bundle)** — Row M5d COMPLETE (Attempt #196). Remaining work (M5e–M5g): refresh `compare_scaling_traces` documentation to call out the expected φ=0 delta, archive targeted pytest stdout/stderr under the Option 1 bundle (CPU mandatory, CUDA optional), then sync this plan + ledger toward optional Phase M6.
