...
class TestUnitConversions:
    ...
    def test_mm_to_angstroms_gradient(self):
        ...
        torch.testing.assert_close(input_tensor.grad, torch.tensor([10000.0]))
    ...
    def test_degrees_to_radians_scalar(self):
        ...
        import math
        assert abs(degrees_to_radians(180.0) - math.pi) < 1e-7  # Reduced precision for float32
    ...
    def test_batch_tensor_conversions(self):
        ...
        expected = torch.tensor([[10000.0, 20000.0], [30000.0, 40000.0]])
        torch.testing.assert_close(result, expected)