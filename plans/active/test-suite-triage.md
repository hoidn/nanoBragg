...
- Phase M1 🔄 in progress — C1 (CLI fixtures) closed in Attempt #21, C3 (detector dtype conversion) closed in Attempt #22, C4 (debug trace summary) closed in Attempt #25 (`reports/2026-01-test-suite-triage/phase_m1/20251011T164229Z/debug_trace/summary.md`), and C5 (simulator API kwargs) closed in Attempt #26; remaining Sprint 0 cluster (C7) pending execution before re-attempting MOSFLM remediation.
