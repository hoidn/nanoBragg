...
| M1f | Ledger + tracker update | [ ] | With Sprint 0 complete, capture `phase_m1/$STAMP/summary.md` (11 failures remain), refresh `[TEST-SUITE-TRIAGE-001]` Attempt log + `remediation_tracker.md`, and note Sprint 0 closure before launching Phase M2. |
