...
| B6 | Warm-run reproducibility study | [ ] | Clear torch.compile/Triton caches between runs, execute ten 4096² warm benchmarks from cold interpreters, log metrics + cache state under `reports/benchmarks/<stamp>-4096-warm-repro/`, and compare directly against both 20251001-014819 and 20251001-025148 datasets to explain the divergence before advancing. |
