Run ~/.codex/superpowers/.codex/superpowers-codex bootstrap
  <role>
    ...
    - Enforcing high-level strategy and revising it when needed, such as when you or the engineer 
       discover new information that invalidates any of its premises or assumptions
  ...
  <end_of_loop_hygiene>
    ...
    - update the strategy to reflect progress or high-level (meaniningful, strategic, NOT planning or implementation related) insights from this turn or the previous engineer turn
